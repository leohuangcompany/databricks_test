...
# MAGIC To run this demo, just select the cluster `dbdemos-lakehouse-retail-c360-leo_huang` from the dropdown menu ([open cluster configuration](https://adb-4472318973269700.0.azuredatabricks.net/#setting/clusters/0424-121222-vizjgqs3/configuration)). <br />
...
# MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=lakehouse&org_id=4472318973269700&notebook=%2F01-Data-ingestion%2Fplain-spark-delta-pipeline%2F01.5-Delta-pipeline-spark-churn&demo_name=lakehouse-retail-c360&event=VIEW&path=%2F_dbdemos%2Flakehouse%2Flakehouse-retail-c360%2F01-Data-ingestion%2Fplain-spark-delta-pipeline%2F01.5-Delta-pipeline-spark-churn&version=1">
...
# MAGIC %sql 
# MAGIC LIST '/Volumes/main/dbdemos_retail_c360/c360/users'

# COMMAND ----------

# DBTITLE 1,Review the raw user data received as JSON
# MAGIC %sql
# MAGIC SELECT * FROM json.`/Volumes/main/dbdemos_retail_c360/c360/users`
...
# MAGIC
# MAGIC
# MAGIC Switch to Databricks SQL to see how this data can easily be requested using <a href='/sql/dashboards/8d3fd289-6d19-4559-a44e-6a18a41e3d3b' target="_blank">Churn prediction DBSQL dashboard</a>, or an external BI tool. 
# MAGIC
