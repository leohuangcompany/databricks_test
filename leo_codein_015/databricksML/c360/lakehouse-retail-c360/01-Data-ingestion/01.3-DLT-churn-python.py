...
# MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=lakehouse&org_id=4472318973269700&notebook=%2F01-Data-ingestion%2F01.3-DLT-churn-python&demo_name=lakehouse-retail-c360&event=VIEW&path=%2F_dbdemos%2Flakehouse%2Flakehouse-retail-c360%2F01-Data-ingestion%2F01.3-DLT-churn-python&version=1">
...
def churn_app_events():
  return (
    spark.readStream.format("cloudFiles")
      ...
      .load("/Volumes/main/dbdemos_retail_c360/c360/events"))
...
def churn_orders_bronze():
  return (
    spark.readStream.format("cloudFiles")
      ...
      .option("cloudFiles.inferColumnTypes", "true")
      .load("/Volumes/main/dbdemos_retail_c360/c360/orders"))
...
def churn_users_bronze():
  return (
    spark.readStream.format("cloudFiles")
      .option("cloudFiles.format", "json")
      .option("cloudFiles.inferColumnTypes", "true")
      .load("/Volumes/main/dbdemos_retail_c360/c360/users"))
...
#                                                                                   Model name               |        
#                                                                                       |                    |        
predict_churn_udf = mlflow.pyfunc.spark_udf(spark, "models:/main.dbdemos_retail_c360.dbdemos_customer_churn@prod", "int")
