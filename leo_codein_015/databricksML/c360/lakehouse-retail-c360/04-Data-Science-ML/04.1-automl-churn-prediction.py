...
# MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=lakehouse&org_id=4472318973269700&notebook=%2F04-Data-Science-ML%2F04.1-automl-churn-prediction&demo_name=lakehouse-retail-c360&event=VIEW&path=%2F_dbdemos%2Flakehouse%2Flakehouse-retail-c360%2F04-Data-Science-ML%2F04.1-automl-churn-prediction&version=1">
...
# MAGIC
# MAGIC <a href='/sql/dashboards/8d3fd289-6d19-4559-a44e-6a18a41e3d3b'>Open the Churn prediction DBSQL dashboard</a> | [Go back to the introduction]($../00-churn-introduction-lakehouse)
# MAGIC
