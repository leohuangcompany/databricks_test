...
-- MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=lakehouse&org_id=4472318973269700&notebook=%2F00-churn-introduction-lakehouse&demo_name=lakehouse-retail-c360&event=VIEW&path=%2F_dbdemos%2Flakehouse%2Flakehouse-retail-c360%2F00-churn-introduction-lakehouse&version=1">
...
-- MAGIC %md 
-- MAGIC Open the [Data Warehousing notebook]($./03-BI-data-warehousing/03-BI-Datawarehousing) to start running your BI queries or access or directly open the <a href="/sql/dashboards/2063a4ab-5494-42b5-b6a5-20089e9c1f5c" target="_blank">Churn Analysis Dashboard</a>
...
-- MAGIC %md
-- MAGIC
-- MAGIC Open the <a href='/sql/dashboards/8d3fd289-6d19-4559-a44e-6a18a41e3d3b' target="_blank">Churn prediction DBSQL dashboard</a> to have a complete view of your business, including churn prediction and proactive analysis.
