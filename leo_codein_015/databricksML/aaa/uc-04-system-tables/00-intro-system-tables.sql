...
-- MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=governance&org_id=4472318973269700&notebook=%2F00-intro-system-tables&demo_name=uc-04-system-tables&event=VIEW&path=%2F_dbdemos%2Fgovernance%2Fuc-04-system-tables%2F00-intro-system-tables&version=1">
...
-- MAGIC
-- MAGIC [Open the dashboard](/sql/dashboards/1e7a9180-8487-48d9-b070-eae013d13e17) to review the informations available for you.<br/><br/>
-- MAGIC
