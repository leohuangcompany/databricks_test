...
output_table_path = "/FileStore/batch-inference/walsin_steel_size"
...
# MAGIC ```python
# MAGIC output_table = "" # Example: "ml.batch-inference.walsin_steel_size"
