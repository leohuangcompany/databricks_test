...
model_name = "walsin_steel_class1"
...
model_name = "walsin_steel_class1"
input_table_name = "walsin_catalog.walsin_schema.walsin_steel_gold"
output_table_path = "/FileStore/batch-inference/walsin_steel_class1"
...
# MAGIC ```python
# MAGIC output_table = "" # Example: "ml.batch-inference.walsin_steel_class1"
...
output_table_path_formatted = f"{output_table_path}_{datetime.now().isoformat()}".replace(":", ".")
output_df.write.format('parquet').option('mode', 'overwrite').save(output_table_path_formatted)
