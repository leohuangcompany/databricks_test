...
model_name = "walsin_steel_test_model"
...
output_table_path = "/FileStore/batch-inference/walsin_steel_test_model"
...
# MAGIC ```python
# MAGIC output_table = "" # Example: "ml.batch-inference.walsin_steel_test_model"
