...
output_table_path = "/FileStore/batch-inference/walsin_class_test1"
...
# MAGIC ```python
# MAGIC output_table = "" # Example: "ml.batch-inference.walsin_class_test1"
...
# 若要寫入 Delta 实时表，请参阅上面的说明
output_df.write.save("{}_{}".format(output_table_path, datetime.now().isoformat()))
