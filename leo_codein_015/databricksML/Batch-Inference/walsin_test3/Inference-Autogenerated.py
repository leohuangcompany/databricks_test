...
model_name = "walsin_test3"
input_table_name = "walsin_schema.walsin_steel_gold_drift_metrics"
output_table_path = "/FileStore/batch-inference/walsin_test3"
...
# MAGIC ```python
# MAGIC output_table = "" # Example: "ml.batch-inference.walsin_test3"
